...
module.exports.tree = function (req, res, next) {
  res.render('demo/canvas/tree', { title: 'tree'
        });
}
module.exports.particle = function (req, res, next) {
  res.render('demo/canvas/particle', { title: 'particle'
        });
}
module.exports.image = function (req, res, next) {
  res.render('demo/canvas/image', { title: 'image'
        });
}
module.exports.magnifier = function (req, res, next) {
  res.render('demo/canvas/magnifier', { title: 'magnifier'
        });
}